...
public void sendText(View view) {
    ...
    public void alert(){
        ...
        .setMessage("Hello! I am a university student that programs in my spare time, check out my other apps!. I've made this app primarly for those kinds of people" +
        		" that enjoy to go out and meet new people at the bar or music venue. This feedback page is also used for you to send me" +
        		" direct feedback about the app." +
        		"\n \n" +
        		"I made this feedback a part of the user experience because I want to help you, the paid user, accomplish amazingness in the field." +
